...
import { Mail, Lock, User, Wallet, Eye, EyeOff, Phone } from 'lucide-react'
      ...
      >
        ...
        <div className="glass-effect rounded-2xl p-8 glow-effect">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full py-3 px-6 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold hover:shadow-lg hover:shadow-purple-500/50 transition-all transform hover:scale-[1.02] active:scale-[0.98]"
            >
              Create Account
            </button>
          </form>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="py-3 px-6 rounded-xl glass-effect hover:bg-white/10 transition-all flex items-center justify-center space-x-2">
